...
var result = {path:"../../../mainContainer/client/resources/css/skins/facebook.css",children:[]};
result.data = "body a {\n  color: #3b5998;\n}\nbody .profile-info.dropdown .dropdown-menu {\n  background: #3b5998;\n  border-color: #3b5998;\n}\nbody .profile-info.dropdown .dropdown-menu > li {\n  border-bottom-co" + 
 ...
 "y .page-container .sidebar-menu .logo-env > div.sidebar-collapse a:hover {\n  background: #344e86;\n}\nbody .page-container .sidebar-menu .sidebar-user-info {\n  border-color: #344e86;\n}\nbody .page-" + 
 ...
 "over-secondary.right .arrow:after {\n  border-right-color: #1a2843;\n}\nbody .popover.popover-secondary.bottom .arrow {\n  border-bottom-color: #1a2843;\n}\nbody .popover.popover-secondary.bottom .arr" + 
 ...
 ".horizontal-menu header.navbar > ul > li#search .search-input::-webkit-input-placeholder {\n  color: #ffffff;\n}\nbody .horizontal-menu header.navbar .navbar-inner > ul > li#search .search-input:-moz-" + 
 "placeholder,\nbody .horizontal-menu header.navbar > ul > li#search .search-input:-moz-placeholder {\n  color: #ffffff;\n}\nbody .horizontal-menu header.navbar .navbar-inner > ul > li#search .search-in" + 
 "put::-moz-placeholder,\nbody .horizontal-menu header.navbar > ul > li#search .search-input::-moz-placeholder {\n  color: #ffffff;\n}\nbody .horizontal-menu header.navbar .navbar-inner > ul > li#search" + 
