...
var result = {path:"../../../mainContainer/client/resources/css/skins/white.css",children:[]};
result.data = "body.login-page .login-form .form-group.lockscreen-input .lockscreen-details h4 {\n  color: #51555d;\n}\nbody.login-page .login-form .form-group.lockscreen-input .lockscreen-details span {\n  color: #" + 
 ...
 "age-container .sidebar-menu .sidebar-user-info .user-link img + span,\nbody .page-container .sidebar-menu .sidebar-user-info .user-link img + strong,\nbody .page-container .sidebar-menu .sidebar-user-" + 
 "info .sui-hover.visible.animate-in a,\nbody .page-container .sidebar-menu .sidebar-user-info .sui-hover.visible .close-sui-popup {\n  color: #51555d;\n}\nbody #chat .chat-conversation .conversation-bo" + 
 ...
 " 2px;\n}\nbody.login-page.logging-in .login-progressbar div {\n  background: #ee4749;\n}\nbody.login-page.logging-in .login-progressbar-indicator {\n  color: #51555d;\n}\nbody.login-page.logging-in .l" + 
 "ogin-progressbar-indicator h3 {\n  color: #51555d;\n}\nbody.page-left-in,\nbody.page-right-in,\nbody.page-fade-only,\nbody.page-fade {\n  background: #ffffff !important;\n}\nbody .page-container.horiz" + 
 "ontal-menu header.navbar.navbar-fixed-top {\n  border-bottom: 1px solid #ebebec;\n}\nbody .page-container .sidebar-menu #main-menu li#search button i {\n  color: #51555d;\n}\nbody .page-container.hori" + 
 "zontal-menu header.navbar .navbar-nav > li.active.has-sub > a:after {\n  border-color: #f7f7f7 rgba(0, 0, 0, 0) rgba(0, 0, 0, 0) rgba(0, 0, 0, 0);\n}\nbody .page-container.horizontal-menu header.navba" + 
 ...
 "hat-conversation .chat-textarea textarea:-moz-placeholder {\n  color: #51555d;\n}\nbody #chat .chat-conversation .chat-textarea textarea::-moz-placeholder {\n  color: #51555d;\n}\nbody #chat .chat-con" + 
 "versation .chat-textarea textarea:-ms-input-placeholder {\n  color: #51555d;\n}\nbody .page-container.horizontal-menu header.navbar .navbar-nav > li ul li a {\n  color: #51555d;\n}\nbody .page-contain" + 
 "er.horizontal-menu header.navbar .navbar-inner > ul > li#search button i,\nbody .page-container.horizontal-menu header.navbar > ul > li#search button i {\n  color: #51555d;\n}\nbody .page-container.si" + 
 "debar-collapsed .sidebar-menu #main-menu > li.has-sub:hover.has-sub > a:hover,\nbody .page-container.sidebar-collapsed .sidebar-menu #main-menu > li:hover.has-sub > a:hover {\n  color: #51555d;\n}\nbo" + 
 "dy .horizontal-menu header.navbar .navbar-inner > ul > li#search .search-input::-webkit-input-placeholder,\nbody .horizontal-menu header.navbar > ul > li#search .search-input::-webkit-input-placeholde" + 
 "r {\n  color: #51555d;\n}\nbody .horizontal-menu header.navbar .navbar-inner > ul > li#search .search-input:-moz-placeholder,\nbody .horizontal-menu header.navbar > ul > li#search .search-input:-moz-p" + 
 "laceholder {\n  color: #51555d;\n}\nbody .horizontal-menu header.navbar .navbar-inner > ul > li#search .search-input::-moz-placeholder,\nbody .horizontal-menu header.navbar > ul > li#search .search-in" + 
 "put::-moz-placeholder {\n  color: #51555d;\n}\nbody .horizontal-menu header.navbar .navbar-inner > ul > li#search .search-input:-ms-input-placeholder,\nbody .horizontal-menu header.navbar > ul > li#se" + 
 "arch .search-input:-ms-input-placeholder {\n  color: #51555d;\n}\nbody .page-container.horizontal-menu header.navbar ul.nav > li > a {\n  color: #51555d;\n}\nbody .page-container.horizontal-menu heade" + 
 "r.navbar ul.nav > li > a:hover,\nbody .page-container.horizontal-menu header.navbar ul.nav > li > a:focus {\n  color: #45494f;\n}\nbody .page-container.horizontal-menu header.navbar ul.nav > li.dropdo" + 
