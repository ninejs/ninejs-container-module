...
var result = {path:"../../../client/resources/css/skins/yellow.css",children:[]};
result.data = "body a {\n  color: #e8b51b;\n}\nbody .profile-info.dropdown .dropdown-menu {\n  background: #e8b51b;\n  border-color: #e8b51b;\n}\nbody .profile-info.dropdown .dropdown-menu > li {\n  border-bottom-co" + 
 ...
 "dy #chat .chat-conversation .chat-textarea textarea:-moz-placeholder {\n  color: #fbf1df;\n}\nbody #chat .chat-conversation .chat-textarea textarea::-moz-placeholder {\n  color: #fbf1df;\n}\nbody #cha" + 
 "t .chat-conversation .chat-textarea textarea:-ms-input-placeholder {\n  color: #fbf1df;\n}\nbody .page-container.horizontal-menu header.navbar .navbar-nav > li ul li a {\n  color: #fbf1df;\n}\nbody .p" + 
 "age-container.horizontal-menu header.navbar .navbar-inner > ul > li#search button i,\nbody .page-container.horizontal-menu header.navbar > ul > li#search button i {\n  color: #fbf1df;\n}\nbody .page-c" + 
 "ontainer.sidebar-collapsed .sidebar-menu #main-menu > li.has-sub:hover.has-sub > a:hover,\nbody .page-container.sidebar-collapsed .sidebar-menu #main-menu > li:hover.has-sub > a:hover {\n  color: #fbf" + 
 ...
 "opover-secondary.left .arrow:after {\n  border-left-color: #222222;\n}\nbody .tooltip.tooltip-primary .tooltip-inner {\n  background-color: #e8b51b;\n  color: #fbf1df;\n}\nbody .tooltip.tooltip-primar" + 
 "y.top .tooltip-arrow {\n  border-top-color: #e8b51b;\n}\nbody .tooltip.tooltip-primary.top-left .tooltip-arrow {\n  border-top-color: #e8b51b;\n}\nbody .tooltip.tooltip-primary.top-right .tooltip-arro" + 
